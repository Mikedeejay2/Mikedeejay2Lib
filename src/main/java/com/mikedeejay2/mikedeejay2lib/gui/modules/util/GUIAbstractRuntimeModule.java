 ...
 * @author Mikedeejay2
 */
public abstract class GUIAbstractRuntimeModule implements GUIModule {
    /**
     ...
     */
    protected GUIAbstractRuntimeModule.ConsumerRunnable runnable;
     ...
     */
    public GUIAbstractRuntimeModule(BukkitPlugin plugin, int delay, int period) {
        this.plugin = plugin;
        this.delay = delay;
        this.period = period;
    }
    ...
    public void onOpenHead(Player player, GUIContainer gui) {
        this.runnable = new ConsumerRunnable(gui, player, this.getConsumer());
    ...
    protected abstract Consumer<RunInfo> getConsumer();
