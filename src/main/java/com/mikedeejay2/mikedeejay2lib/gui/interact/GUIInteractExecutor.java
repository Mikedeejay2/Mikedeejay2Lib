...
public interface GUIInteractExecutor
{
     ...
     *
     * @param player    The <code>Player</code> interacting with the GUI
     * @param inventory The <code>Inventory</code> that was interacted with
     * @param slot      The slot that was interacted with
     * @param event     The event of the click
     * @param gui       The <code>GUIContainer</code> that was interacted with
     * @param layer     The <code>GUILayer</code> that items should be placed on
     */
