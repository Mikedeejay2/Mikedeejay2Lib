 ...
 * @author Mikedeejay2
 */
public class GUIInteractHandlerListSingleton extends GUIInteractHandler
{
    protected int limit;

    public GUIInteractHandlerListSingleton(int limit)
    {
        super();
        this.limit = Math.min(limit, 64);
        executors.add(new GUIInteractExecutorDefaultInv(this.limit));
        executors.add(new GUIInteractExecutorListSingleton(this.limit));
    }

    public GUIInteractHandlerListSingleton()
    {
        super();
        this.limit = -1;
        executors.add(new GUIInteractExecutorDefaultInv(this.limit));
