...
public class NMS_Merchant_v1_14_R1 implements NMS_Merchant
{
    ...
    public void postProcess(org.bukkit.entity.Villager villager, org.bukkit.inventory.MerchantRecipe recipe)
    {
        ...
        try
        {
            Field lastTraded = EntityVillager.class.getDeclaredField("bG");
        ...
        if (shouldLevelUp(villager)) {
            try
            {
                // nmsVillager.bt = 40;
                // nmsVillager.bu = true;
                Field villagerField1 = EntityVillager.class.getDeclaredField("bE");
                villagerField1.setAccessible(true);
                villagerField1.set(nmsVillager, 40);
                Field villagerField2 = EntityVillager.class.getDeclaredField("bF");
